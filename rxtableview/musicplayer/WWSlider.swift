...
class WWSlider: UISlider {
    ...
    fileprivate func setup() {
        minimumTrackTintColor = UIColor(red: 45/255.0, green: 185/255.0, blue: 105/255.0, alpha: 1.0)
        maximumTrackTintColor = .clear
        setThumbImage(UIImage(named:"player_slider_playback_thumb"), for: .normal)
        progressView = UIProgressView(frame: .zero)
        progressView.progressTintColor = UIColor(white: 0.7, alpha: 1.0)
